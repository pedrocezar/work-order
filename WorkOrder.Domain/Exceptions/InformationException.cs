...
public class InformationException : Exception
{
    ...
    public InformationException(StatusException status, List<string> messages, Exception exception = null)
    ...
    public InformationException(StatusException status, string message, Exception exception = null)
        : base(status.Description(), exception)
    {
        Status = status;
